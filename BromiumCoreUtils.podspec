Pod::Spec.new do |s|
  ...
  s.source_files = 'BromiumCoreUtils/BRUAsserts.{h,m}', 'BromiumCoreUtils/BRUInternalMaybeDDLog.{h,m}', 'BromiumCoreUtils/BRUBaseDefines.{h,m}', 'BromiumCoreUtils/BRUDispatchUtils.{h,m}', 'BromiumCoreUtils/BRUDeferred.{h,m}'
